...
async function displayAlbums(){
    let a = await fetch(proxyUrl + `https://github.com/VersionMaruti/Spotify-Clone/tree/main/songs`);
    let response = await a.text();
    let div = document.createElement("div")
    div.innerHTML = response
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if(e.href.includes("/songs/")){//**/
             ...
             let a = await fetch(proxyUrl + `https://github.com/VersionMaruti/Spotify-Clone/tree/main/songs/${folder}/info.json`)
